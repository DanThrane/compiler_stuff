...
sealed class Node {
    ...
    lateinit var type: Type // TODO Should probably only be on expressions

    companion object {
        val serialNumberCounter = AtomicInteger()
    }
}
...
class VariableDeclarationNode(
    lineNumber: Int,
    var variables: MutableList<FieldDeclarationNode>
) : DeclarationNode(lineNumber) {
...
class FunctionHead(
    override var lineNumber: Int,
    var name: String,
    var parameters: MutableList<FieldDeclarationNode>,
...
class FunctionBody(
    override var lineNumber: Int,
    var declarations: List<DeclarationNode>,
...
class PrimitiveTypeNode(
    lineNumber: Int,
    token: Tokens
) : TypeNode(lineNumber, token)

class IdentifierType(
    lineNumber: Int,
    val identifier: String
) : TypeNode(lineNumber, Tokens.T_ID) {
    override fun toNativeType(): Type = TypeUnresolved(identifier)
}

class RecordTypeNode(
    lineNumber: Int,
    var fields: MutableList<FieldDeclarationNode>
...
) : TypeNode(lineNumber, Tokens.T_ARRAY) {
...
class ArrayAccessNode(
    lineNumber: Int,
    var variableAccessNode: VariableAccessNode,
...
sealed class TermNode(override var lineNumber: Int) : ExpressionNode(lineNumber)
...
class FunctionCallNode(
    lineNumber: Int,
    var name: String,
    var arguments: MutableList<ExpressionNode>
) : TermNode(lineNumber) {
